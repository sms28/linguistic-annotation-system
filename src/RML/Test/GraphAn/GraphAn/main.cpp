...
int main(){
	...
	string InputFile = "C:\\Users\\hp9\\IdeaProjects\\LinguisticAnnotationSystem\\text\\input.txt";//Входной файл html или txt в кодировке CP-1251
	string GraFile = "C:\\Users\\hp9\\IdeaProjects\\LinguisticAnnotationSystem\\text\\output.gra";//Путь к выходному файлу *.gra (Открывается простым блокнотом), если задано только имя файла,то он будет создан в корне проекта(папка с исходным кодом) 
